...
% the torque profiles obtained form inverse dynamic
for i=1:length(time)
...
subplot(312)
plot(time, subs(theta2,time),'r--')
hold on
plot(time,Numtheta(1:length(time),2)*180/pi)
% Create ylabel
ylabel('\theta_2(t) (\circ)');
subplot(313)
plot(time, subs(f,time),'r--')
hold on
...
subplot(312)
plot(time, subs(dtheta2,time),'r--')
hold on
plot(time,NumDtheta(1:length(time),2)*180/pi)
% Create ylabel
ylabel('\theta\prime_2(t) (\circ/sec)');
subplot(313)
plot(time, subs(df,time),'r--')
hold on
...
figure(7)
subplot(311)
plot(time, subs(ddtheta1,time),'r--')
hold on
...
subplot(312)
plot(time, subs(ddtheta2,time),'r--')
hold on
