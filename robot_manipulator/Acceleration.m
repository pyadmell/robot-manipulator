function [dv dw]=Acceleration(JointVelocities,JointAcceleration,alpha,a,d,theta,TypeOfJoints)
...
for i=1:n
    ...
    dv=R*(dv_old+cross(dw_old,P)+cross(w_old,cross(w_old,P)))+...
        isequal(TypeOfJoints(i),'P')*(2*cross(w,[0;0;JointVelocities(i)])+[0;0;JointAcceleration(i)]);
    dw=R*dw_old+isequal(TypeOfJoints(i),'R')*(cross(R*w_old,[0;0;JointVelocities(i)*pi/180])+[0;0;JointAcceleration(i)*pi/180]);
